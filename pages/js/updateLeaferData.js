...
window.updateLeaferData = function (currentFrame, updateMemory = true) {
    try {
        ...
        if (validElementIds.includes('o2o_ele_pan')) {
            // X轴移动（保持不变）
            o2o_ele_pan.children[6].children[0].x = o2o_ele_pan.width / 2 - trkpt_data[currentFrame].distance * o2o_ele_pan.width / 80;
            ...
            o2o_ele_pan.children[6].children[0].y = yOffset;
            o2o_ele_pan.children[9].text = altitude;
        }
