...
;!function(d) {
    ...
    n.prototype.use = function(r, t, e, n) {
        var o = this
          ...
          , u = (r = "string" == typeof r ? [r] : "function" == typeof r ? (t = r,
        ["all"]) : r,
        d.jQuery && jQuery.fn.on && (o.each(r, function(t, e) {
        ...
        function s(t, e) {
            ...
            "load" !== t.type && !r.test((t.currentTarget || t.srcElement).readyState) || (m.modules[u] = e,
            a.removeChild(p),
            function n() {
        ...
        function c() {
            e.push(layui[u]),
            1 < r.length ? o.use(r.slice(1), t, e, n) : "function" == typeof t && (layui.jquery && "function" == typeof layui.jquery && "define" !== n ? layui.jquery(function() {
                t.apply(layui, e)
            }) : t.apply(layui, e))
        }
        if (e = e || [],
    ...
    n.prototype.link = function(r, n, t) {
        ...
        "function" != typeof n || function s(t) {
            ...
            return ++l > 1e3 * m.timeout / 100 ? g(r + " timeout") : void (1989 === parseInt(o.getStyle(e, "width")) ? (t === u && e.removeAttribute("lay-status"),
    ...
    n.prototype.router = n.prototype.hash = function(t) {
        ...
        this.each(t, function(t, e) {
            /^\w+=/.test(e) ? (e = e.split("="),
            r.search[e[0]] = e[1]) : r.path.push(e)
        })),
        r
    }
    ,
    ...
    n.prototype.event = n.event = function(t, e, r, n) {
        ...
        return r === s ? (delete (o.cache.event[t] || {})[u],
        o) : n ? (m.event[t] = m.event[t] || {},
...
!function(l) {
    ...
    var t, f = l.document, h = function(t) {
        ...
        for (var e = 0, n = "object" == typeof t ? layui.isArray(t) ? t : [t] : (this.selector = t,
    ...
    h.position = function(t, e, n) {
        ...
        i = u.left,
        c = u.bottom,
        "center" === n.align ? i -= (a - t.offsetWidth) / 2 : "right" === n.align && (i = i - a + t.offsetWidth),
        (i = i + a + 5 > (r = function(t) {
            return f.documentElement[t ? "clientWidth" : "clientHeight"]
        }
        )("width") ? r("width") - a - 5 : i) < 5 && (i = 5),
        c + s + 5 > r() && (u.top > s + 5 ? c = u.top - s - 10 : "right" === n.clickType ? (c = r() - s - 10) < 0 && (c = 0) : c = 5),
        ...
        !n.SYSTEM_RELOAD && s.bottom + 5 > r() && (n.SYSTEM_RELOAD = !0,
        setTimeout(function() {
            h.position(t, e, n)
        }, 50))))
    }
...
!function(i, p) {
    ...
    I.prototype.render = function() {
        ...
        i.join(""))).find("li").on("click", function(e) {
            ...
            r.done(null, "change"),
            lay(this).addClass(x),
            "static" !== o.position && !o.range && o.autoConfirm && ("date" === n ? r.choose(lay(y).find("td.layui-this")) : "year" !== n && "month" !== n || lay(m[0]).find("." + E + " li." + x + ":not(.laydate-disabled)")[0] && r.setValue(r.parse()).done().remove())
        })),
        lay.each(m, function(e, t) {
            y.appendChild(t)
        }),
        o.showBottom && y.appendChild(e),
        lay.elem("style")), g = [], t = (lay.each(o.theme, function(e, t) {
            /^#/.test(t) && (l = !0,
            g.push(["#{{id}} .layui-laydate-header{background-color:{{theme}};}", "#{{id}} li.layui-this,#{{id}} td.layui-this>div{background-color:{{theme}} !important;}", -1 !== o.theme.indexOf("circle") ? "" : "#{{id}} .layui-this{background-color:{{theme}} !important;}"].join("").replace(/{{id}}/g, r.elemID).replace(/{{theme}}/g, t)))
        }),
        o.shortcuts && o.range && g.push("#{{id}}.layui-laydate-range{width: 628px;}".replace(/{{id}}/g, r.elemID)),
        g.length && (g = g.join(""),
        "styleSheet"in f ? (f.setAttribute("type", "text/css"),
        f.styleSheet.cssText = g) : f.innerHTML = g,
        l && lay(y).addClass("laydate-theme-molv"),
        y.appendChild(f)),
        r.remove(I.thisElemDate),
        v.thisId = o.id,
        s ? o.elem.append(y) : (p.body.appendChild(y),
        r.position()),
    ...
    I.prototype.list = function(n, i) {
        ...
        }), a = d.elemHeader[i], c = lay(a[2]).find("span"), h = d.elemCont[i || 0], f = lay(h).find("." + w)[0], g = "cn" === s.lang, p = g ? "\u5e74" : "", v = d.listYM[i] || {}, D = ["hours", "minutes", "seconds"], T = ["startTime", "endTime"][i];
        return v[0] < 1 && (v[0] = 1),
        "year" === n ? (e = l = v[0] - 7,
        l < 1 && (e = l = 1),
    ...
    l.run = function(n) {
        n(p).on("mousedown", function(e) {
            ...
            var t;
            !v.thisId || (t = s.getThis(v.thisId)) && "static" !== t.config.position && 13 === e.keyCode && n("#" + t.elemID)[0] && t.elemID === I.thisElemDate && (e.preventDefault(),
...
!function(p) {
    ...
    var m, c, e, n = p.layui && layui.define, f = {
        ...
        link: function(e, i, t) {
            ...
            "function" == typeof i && function c(e) {
                ...
                return 100 < ++r ? p.console && console.error(o + ".css: Invalid") : void (1989 === parseInt(f.getStyle(t, "width")) ? (e === l && t.removeAttribute("lay-status"),
        ...
        path: f.getPath,
        config: function(e, t) {
            return h.cache = f.config = m.extend({}, f.config, e = e || {}),
        ...
        msg: function(e, t, i) {
            ...
            h.open(m.extend({
                ...
                anim: o
            } : (-1 !== (t = t || {}).icon && (void 0 !== t.icon || f.config.skin) || (t.skin = a + " " + (t.skin || "layui-layer-hui")),
            t)))
        },
        load: function(e, t) {
            return h.open(m.extend({
    ...
    ["layui-layer", ".layui-layer-title", ".layui-layer-main", ".layui-layer-dialog", "layui-layer-iframe", "layui-layer-content", "layui-layer-btn", "layui-layer-close"]), i = (d.anim = {
        0: "layer-anim-00",
        1: "layer-anim-01",
        2: "layer-anim-02",
        3: "layer-anim-03",
    ...
    t.pt.vessel = function(e, t) {
        ...
        a.closeBtn && n.push('<span class="layui-icon layui-icon-close ' + [d[7], d[7] + (a.title ? a.closeBtn : 4 == a.type ? "1" : "2")].join(" ") + '"></span>'),
        ...
        }() : "") + (a.resize ? '<span class="layui-layer-resize"></span>' : "") + "</div>"], s, m('<div class="' + d.MOVE + '" id="' + d.MOVE + '"></div>')),
        this
    }
    ,
    t.pt.creat = function() {
        ...
        if (!a.id || !m("." + d[0]).find("#" + a.id)[0]) {
            switch (a.removeFocus && document.activeElement.blur(),
            "string" == typeof a.area && (a.area = "auto" === a.area ? ["", ""] : [a.area, ""]),
            a.shift && (a.anim = a.shift),
            6 == h.ie && (a.fixed = !1),
            a.type) {
            case 0:
                a.btn = "btn"in a ? a.btn : f.btn[0],
                h.closeAll("dialog");
                break;
            case 2:
            ...
            n.vessel(s, function(e, t, i) {
                l.append(e[0]),
                s ? 2 == a.type || 4 == a.type ? m("body").append(e[1]) : r.parents("." + d[0])[0] || (r.data("display", r.css("display")).show().addClass("layui-layer-wrap").wrap(e[1]),
                m("#" + d[0] + o).find("." + d[5]).before(t)) : l.append(e[1]),
            ...
            parseInt(f.getStyle(document.getElementById(d.MOVE), "z-index")) || (n.layero.css("visibility", "hidden"),
            h.ready(function() {
                n.offset(),
    ...
    t.pt.auto = function(e) {
        ...
        e("." + d[5])) : t.fixed && n[1] >= c.height() && (n[1] = c.height(),
        e("." + d[5])) : e("." + d[5]),
        this
    }
    ,
    t.pt.offset = function() {
        ...
        "min" === i.data("maxminStatus") && (e.offsetTop = c.height() - (i.find(d[1]).outerHeight() || 0),
    ...
    t.pt.tips = function() {
        ...
        a.where[n - 1](),
        1 === n ? a.top - (c.scrollTop() + i[1] + 16) < 0 && a.where[2]() : 2 === n ? 0 < c.width() - (a.left + a.width + i[0] + 16) || a.where[3]() : 3 === n ? 0 < a.top - c.scrollTop() + a.height + i[1] + 16 - c.height() && a.where[0]() : 4 === n && 0 < i[0] + 16 - a.left && a.where[1](),
        t.find("." + d[5]).css({
    ...
    t.pt.move = function() {
        ...
        f.docEvent || (e.on("mousemove", function(e) {
            var t, i, n, a, o, s, l;
            f.eventMoveElem && (t = (a = f.eventMoveElem.data(r[0]) || {}).layero,
            o = a.config,
            ...
            o.moveOut || (i = c.width() - t.outerWidth() + a.stX,
            ...
            var t, i;
            f.eventMoveElem && (i = (t = f.eventMoveElem.data(r[0]) || {}).config,
            f.eventMoveElem.removeData(r[0]),
            delete f.eventMoveElem,
            f.moveElem.hide(),
            i.moveEnd && i.moveEnd(t.layero)),
            f.eventResizeElem && (f.eventResizeElem.removeData(r[1]),
    ...
    h.min = function(e, t) {
        ...
        "min" !== r && ("max" === r && h.restore(e),
        l.data("maxminStatus", "min"),
        r = m("#" + d.SHADE + e),
        i = l.find(d[1]).outerHeight() || 0,
        a = (n = "string" == typeof (a = l.attr("minLeft"))) ? a : 181 * f.minStackIndex + "px",
        o = l.css("position"),
        s = {
            width: 180,
            height: i,
        ...
        f.record(l),
        0 < f.minStackArr.length && (a = f.minStackArr[0],
        f.minStackArr.shift()),
        parseFloat(a) + 180 > c.width() && (a = c.width() - 180 - (f.minStackArr.edgeIndex = f.minStackArr.edgeIndex || 0,
        f.minStackArr.edgeIndex += 3)) < 0 && (a = 0),
        t.minStack && (s.left = a,
        s.top = c.height() - i,
        n || f.minStackIndex++,
        l.attr("minLeft", a)),
    ...
    h.close = function(a, o) {
        var s, e, l = (t = m("." + d[0]).find("#" + a).closest("." + d[0]))[0] ? (a = t.attr("times"),
        t) : m("#" + d[0] + a), r = l.attr("type"), t = l.data() || {}, i = {
            slideDown: "layer-anim-slide-down-out",
            slideLeft: "layer-anim-slide-left-out",
            slideUp: "layer-anim-slide-up-out",
            slideRight: "layer-anim-slide-right-out"
        }[t.anim] || "layer-anim-close";
        l[0] && (s = "layui-layer-wrap",
        e = function() {
            if (r === f.type[1] && "object" === l.attr("conType")) {
                l.children(":not(." + d[5] + ")").remove();
                for (var e = l.find("." + s), t = 0; t < 2; t++)
                    e.unwrap();
            ...
            delete f.end[a],
            "function" == typeof o && o(),
            f.events.resize[a] && (c.off("resize", f.events.resize[a]),
        ...
        h.ie && h.ie < 10 || !l.data("isOutAnim") ? e() : setTimeout(function() {
            e()
        }, 200))
    }
    ,
...
layui.define(["jquery", "lay"], function(e) {
    ...
    var m = layui.$
      ...
      , T = "layui-colorpicker-main-input"
      , Y = function(e) {
        var i = {
            h: 0,
            s: 0,
    ...
    d.prototype.val = function() {
        ...
        i.elemColorBox.find("." + C)), r = i.elemPicker.find("." + T), t = o[0].style.backgroundColor;
        t ? (e = Y(L(t)),
        o = o.attr("lay-type"),
        ...
        i.elemPicker.find("." + E).css("left", 280)) : (r.find("input").val(t),
        t = 280 * t.slice(t.lastIndexOf(",") + 1, t.length - 1),
        i.elemPicker.find("." + E).css("left", t)),
    ...
    d.prototype.side = function() {
        var n = this
          ...
          , y = function(e, i, o, r) {
            ...
            l.change && l.change(n.elemPicker.find("." + T).find("input").val())
        }
        ...
        var c = this
          ...
          , o = {
            ...
            confirm: function(e, i) {
                ...
                c.elemPicker.find("." + E).css("left", t),
                    ...
                    var l = b(this)
                      ...
                      , n = function(t) {
                        ...
                        e.on("click", function() {
                            ...
                            b(this).hasClass(F) || ("function" == typeof t.click && t.click.call(this, l, t),
                ...
                var v, c = "\u8bf7\u9009\u62e9", m = "layui-form-select", g = "layui-select-title", x = "layui-select-none", k = "", e = e || a.find("select"), C = function(e, t) {
                    ...
                    d.on("keyup", function(e) {
                        ...
                        function(a, n) {
                            ...
                            var e = function() {
                              ...
                              , i = e[a]("dd:not(." + $ + ")");
                            return t[0] ? (s = e[a](),
                            i[0] && !i.hasClass(F) || !s[0] ? (i.addClass(T).siblings().removeClass(T),
                            void o()) : r(a, s)) : s = null
                        }
                        );
                        38 === e && r("prev"),
                    ...
                    h.on("click", function() {
                        var e = b(this)
                          , t = e.attr("lay-value")
                          , i = c.attr("lay-filter");
                        return e.hasClass(F) || (e.hasClass("layui-select-tips") ? d.val("") : (d.val(e.text()),
                        e.addClass(T)),
                ...
                e.each(function(e, t) {
                    ...
                    function(i, a) {
                        ...
                        i.on("click", function() {
                            ...
                            i.find(o.SUBTRA).removeClass(o.SUBTRA).addClass("layui-icon-ok")),
            ...
            radio: function(e) {
                ...
                e.each(function(e, t) {
                    ...
                    if ("string" == typeof i.attr("lay-ignore"))
                        return i.show();
                    a[0] && a.remove();
                    n = b(['<div class="layui-unselect ' + r, t.checked ? " " + r + "ed" : "", (n ? " layui-radio-disabled " + F : "") + '">', '<i class="layui-anim layui-icon">' + s[t.checked ? 0 : 1] + "</i>", "<div>" + (a = d.escape(t.title || ""),
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function(e) {
    ...
    var p = layui.$
      ...
      , k = function(e) {
        var t = x.that[e];
        return t || u.error(e ? "The table instance with ID '" + e + "' not found" : "ID argument required"),
        t || null
    }
      , l = function(e) {
        var t = x.config[e];
      ...
      , C = function(e) {
        var t = this.config || {}
          , a = (e = e || {}).item3
          , i = e.content
          , t = (("escape"in a ? a : t).escape && (i = v.escape(i)),
    ...
    n.prototype.setGroupWidth = function(i) {
        var e, l = this;
        l.config.cols.length <= 1 || ((e = l.layHeader.find((i ? "th[data-key=" + i.data("parentkey") + "]>" : "") + "." + M)).css("width", 0),
    ...
    n.prototype.setColsWidth = function() {
        ...
        y = y - ("line" === d.skin || "nob" === d.skin ? 2 : i + 1) - n.getScrollWidth(n.layMain[0]) - 1,
        function(o) {
            layui.each(d.cols, function(e, n) {
                layui.each(n, function(e, t) {
                    ...
                    a = i) : c && l < c && (r--,
                    a = l) : (a = t.width || 0,
                    /\d+%$/.test(a) ? l < (a = (a = Math.floor(parseFloat(a) / 100 * y)) < i ? i : a) && (a = l) : a ? "normal" === t.type && (a < i && (t.width = a = i),
    ...
    n.prototype.eachCols = function(e) {
        return b.eachCols(null, e, this.config.cols),
        this
    }
    ,
    ...
    n.prototype.getTrHtml = function(t, a, l, e) {
        ...
        layui.each(t, function(o, d) {
            ...
            "array" === layui.type(d) && 0 === d.length || (d[b.config.numbersName] = s,
            ...
            y.eachCols(function(e, l) {
                ...
                e.join(" ")) + ">" + function() {
                    ...
                    case "radio":
                        return t[a] && (y.thisCheckedRowIndex = o),
                        '<input type="radio" name="layTableRadio_' + u.index + '" ' + (e = [],
                        t[a] && (e[0] = "checked"),
                        t[i] && e.push("disabled"),
    ...
    n.prototype.renderData = function(e) {
        ...
        return b.cache[a.key] = d,
        a.layTotal[0 == d.length ? "addClass" : "removeClass"](L),
        a.layPage[i.page || i.pagebar ? "removeClass" : "addClass"](T),
        a.layPage.find(A)[!i.page || 0 == n || 0 === d.length && 1 == l ? "addClass" : "removeClass"](L),
        0 === d.length ? a.errorView(i.text.none) : (a.layFixLeft.removeClass(T),
        o ? y() : (y(),
        a.renderTotal(d, t),
    ...
    n.prototype.setRowChecked = function(a, e) {
        ...
        a.selectedStyle || e || (l = b.cache[t.key],
    ...
    n.prototype.sort = function(l) {
        ...
        i.autoSort && ("asc" === l.type ? e = layui.sort(o, d) : "desc" === l.type ? e = layui.sort(o, d, !0) : (e = layui.sort(o, b.config.indexName),
        delete t.sortKey,
        delete i.initSort)),
    ...
    n.prototype.syncCheckAll = function() {
        ...
        t[0] && (b.checkStatus(e.key).isAll ? (t[0].checked || (t.prop("checked", !0),
    ...
    n.prototype.fullSize = function() {
        ...
        l && (e = parseFloat(l) - (i.layHeader.outerHeight() || 38),
    ...
    n.prototype.scrollPatch = function() {
        ...
        e.layFixRight[b.cache[e.key] && b.cache[e.key].length && 0 < l ? "removeClass" : "addClass"](T),
    ...
    n.prototype.events = function() {
          ...
          , n = (s.layTool.on("click", "*[lay-event]", function(e) {
            var a, i = p(this), t = i.attr("lay-event"), l = function(e) {
                var t = p(e.list)
                  , a = p('<ul class="' + H + '"></ul>');
                a.html(t),
                y.height && a.css("max-height", y.height - (s.layTool.outerHeight() || 50)),
            ...
            case "LAYTABLE_PRINT":
                ...
                d.find("thead>tr>th." + j).filter(function(e, t) {
        ...
        e.on("mousemove", function(e) {
            var t = p(this)
              , a = t.offset().left
              , e = e.clientX - a;
            t.data("unresize") || x.eventMoveElem || (d.allowResize = t.width() - e <= 10,
        ...
        s.commonMember = function(e) {
          ...
          , t = (s.elem.on("click", 'input[name="layTableCheckbox"]+', function() {
            ...
            s.syncCheckAll()),
            layui.event.call(e[0], w, "checkbox(" + r + ")", n.call(e[0], {
                checked: i,
                type: l ? "all" : "one"
            })))
        }),
        ...
        function(e) {
          ...
          , c = function(e, t) {
            ...
            i = b.cache[s.key][i],
            l = e.children(u),
            (n = "function" == typeof n.edit ? n.edit(i) : n.edit) && ((n = p("textarea" === n ? '<textarea class="layui-input ' + W + '"></textarea>' : '<input class="layui-input ' + W + '">'))[0].value = e.data("content") || i[a] || l.text(),
    ...
    b.checkStatus = function(e) {
        var a = 0
          ...
          , e = b.cache[e] || [];
        return layui.each(e, function(e, t) {
            "array" === layui.type(t) ? i++ : t[b.config.checkName] && (a++,
            t[b.config.disabledName] || l.push(b.clearCacheKey(t)))
        }),
        {
            data: l,
    ...
    b.exportFile = function(e, t, a) {
        ...
        a && (l.type = a),
        l)).type || "csv", c = x.that[e], n = x.config[e] || {}, s = {
            csv: "text/csv",
            xls: "application/vnd.ms-excel"
        }[l], y = document.createElement("a");
        if (g.ie)
            return u.error("IE_NOT_SUPPORT_EXPORTS");
        y.href = "data:" + s + ";charset=utf-8,\ufeff" + encodeURIComponent((o = [],
        d = [],
        i = [],
        r = {},
        layui.each(t, function(i, l) {
            ...
            layui.each(layui.isArray(l) ? p.extend([], l) : b.clearCacheKey(l), function(e, t) {
                ...
                var a;
                t.field && "normal" == t.type && (t.hide ? 0 == i && (r[t.field] = !0) : ((a = l[t.field]) !== undefined && null !== a || (a = ""),
        ...
        o.join(",") + "\r\n" + d.join("\r\n") + "\r\n" + i.join(","))),
        y.download = (a.title || n.title || "table_" + (n.index || "")) + "." + l,
    ...
    b.reloadData = function() {
        var a = p.extend([], arguments)
          , i = (a[3] = "reloadData",
        new RegExp("^(" + ["elem", "id", "cols", "width", "height", "maxHeight", "toolbar", "defaultToolbar", "className", "css", "totalRow", "page", "pagebar"].join("|") + ")$"));
    ...
    b.clearCacheKey = function(e) {
        return delete (e = p.extend({}, e))[b.config.checkName],
...
layui.define(["table"], function(e) {
    ...
    var O = layui.$
      ...
      , p = {
        ...
        set: function(e) {
            var t = this;
            return t.config = O.extend({}, t.config, e),
            t
        },
        resize: Y.resize
    }
      ...
      , E = function(e) {
        var t = o.that[e];
        return t || i.error(e ? "The treeTable instance with ID '" + e + "' not found" : "ID argument required"),
        t || null
    }
      , L = ".layui-table-main"
    ...
    t.prototype.init = function() {
        var i = this
          , e = i.config
          , t = Y.render(O.extend({}, e, {
            data: [],
            url: "",
            done: null
        }))
          , l = t.config.id
          , a = ((o.that[l] = i).tableIns = t,
        e.tree)
          , t = a.customName
          , r = (t.isParent,
        t.children)
        ...
        e.url ? e.parseData = function() {
            var e = arguments
              , t = e[0]
              , e = ("function" === layui.type(n) && (t = n.apply(this, e) || e[0]),
            this.response.dataName);
            return a.data.isSimpleData && !a["async"].enable && (t[e] = i.flatToTree(t[e])),
            i.initData(t[e]),
            t
        }
        : (e.data = e.data || [],
        a.data.isSimpleData && (e.data = i.flatToTree(e.data)),
        e.initSort && e.initSort.type && (e.data = layui.sort(e.data, e.initSort.field, "desc" === e.initSort.type)),
        i.initData(e.data)),
        e.done = function() {
    ...
    var U = function(t, a, n, i, l) {
        ...
        if (l && e != p[F] && (!p.LAY_ASYNC_STATUS || "local" === p.LAY_ASYNC_STATUS)) {
            ...
            if ("function" === layui.type(b) && !1 === b(d, p, a))
                return m
        }
        var b = p[X]
          , g = r.find('tr[lay-data-index="' + s + '"]')
          , v = g.find(".layui-table-tree-flexIcon")
          , f = (v.html(e ? c.view.flexIconOpen : c.view.flexIconClose),
        p[f] && v.css("visibility", "visible"),
        c.view.showIcon && p[f] && !p.icon && !c.view.icon && g.find(".layui-table-tree-nodeIcon").html(e ? c.view.iconOpen : c.view.iconClose),
        p[u.children] || []);
        if (e)
            if (b)
                p[F] = e,
                ...
                if (g.enable && w && !p.LAY_ASYNC_STATUS)
                    return p.LAY_ASYNC_STATUS = "loading",
                    ...
                    (T = g.contentType || o.contentType) && 0 == T.indexOf("application/json") && (N = JSON.stringify(N)),
                    C = g.method || o.method,
                    ...
                    v.html('<i class="layui-icon layui-icon-loading layui-anim layui-anim-loop layui-anim-rotate"></i>'),
                    O.ajax({
                        type: C || "get",
                        url: w,
                        contentType: T,
                        ...
                        success: function(e) {
                            ...
                            (e = "function" == typeof I ? I.call(o, e) || e : e)[S.statusName] != S.statusCode ? (p.LAY_ASYNC_STATUS = "error",
                            v.html('<i class="layui-icon layui-icon-refresh"></i>')) : (p[u.children] = e[S.dataName],
                ...
                p[F] = e,
                b = p[X] = !0,
                f.length && (o.initSort && !o.url && (f = (g = o.initSort).type ? p[u.children] = layui.sort(f, g.field, "desc" === g.type) : p[u.children] = layui.sort(f, Y.config.indexName)),
                y.initData(p[u.children], p[B]),
                ...
                r.find(L).find('tbody tr[lay-data-index="' + s + '"]').after(k.trs),
                r.find(j).find('tbody tr[lay-data-index="' + s + '"]').after(k.trs_fixed),
                r.find(P).find('tbody tr[lay-data-index="' + s + '"]').after(k.trs_fixed_r),
            ...
            r.find(f.map(function(e, t, a) {
                return 'tr[lay-data-index="' + e[B] + '"]'
            }).join(",")).addClass("layui-hide")) : (w = y.treeToFlat(f, p[u.id], s),
            r.find(w.map(function(e, t, a) {
                return 'tr[lay-data-index="' + e[B] + '"]'
            }).join(",")).addClass("layui-hide"));
        return Y.resize(d),
        l && "loading" !== p.LAY_ASYNC_STATUS && (T = c.callback.onExpand,
    ...
    p.expandAll = function(e, t) {
        if ("boolean" !== layui.type(t))
            return i.error("expandAll\u7684\u5c55\u5f00\u72b6\u6001\u53c2\u6570\u53ea\u63a5\u6536true/false");
        e = E(e);
        if (e) {
            var a = e.getOptions()
              , n = a.tree
    ...
    t.prototype.renderTreeTable = function(e, l, t) {
        ...
        r.view || {})
          ...
          , c = n.attr("lay-filter")
          , u = this
          , f = ((l = l || 0) || (n.find(".layui-table-body tr:not([data-level])").attr("data-level", l),
        layui.each(Y.cache[i], function(e, t) {
            n.find('.layui-table-main tbody tr[data-level="0"]:eq(' + e + ")").attr("lay-data-index", t[B]),
            n.find('.layui-table-fixed-l tbody tr[data-level="0"]:eq(' + e + ")").attr("lay-data-index", t[B]),
            n.find('.layui-table-fixed-r tbody tr[data-level="0"]:eq(' + e + ")").attr("lay-data-index", t[B])
        })),
        {})
          , a = a.name
          , s = r.view.indent || 14;
        layui.each(e.find('td[data-field="' + a + '"]'), function(e, t) {
            ...
            (i = n.attr("lay-data-index")) && ((a = u.getNodeDataByIndex(i))[F] && (f[i] = !0),
    ...
    p.formatNumber = function(e) {
        var n, i, l = E(e);
        if (l)
            return n = l.getOptions().elem.next(),
            i = 0,
            layui.each(l.treeToFlat(Y.cache[e]), function(e, t) {
                var a;
                layui.isArray(t) || ((a = l.getNodeDataByIndex(t.LAY_DATA_INDEX)).LAY_NUM = ++i,
                n.find('tr[lay-data-index="' + t.LAY_DATA_INDEX + '"] .laytable-cell-numbers').html(a.LAY_NUM))
            }),
            p
    }
    ,
    t.prototype.render = function(e) {
        var t = this;
        t.tableIns = Y["reloadData" === e ? "reloadData" : "reload"](t.tableIns.config.id, O.extend(!0, {}, t.config)),
    ...
    function(e, a, n) {
      ...
      , n = (t.prototype.updateStatus = function(e, t) {
        var a = this.getOptions()
          , n = a.tree;
        return e = e || Y.cache[a.id],
        l(e, t, n.customName.children)
    }
    ,
    ...
    p.updateStatus = function(e, t, a) {
        var e = E(e)
          , n = e.getOptions();
        return a = a || (n.url ? Y.cache[n.id] : n.data),
        e.updateStatus(a, t)
    }
    ,
    p.sort = function(e) {
        var t, a, n = E(e);
        n && (a = (t = n.getOptions()).initSort,
        t.url || (a.type ? t.data = layui.sort(t.data, a.field, "desc" === a.type) : t.data = layui.sort(t.data, Y.config.indexName),
        n.initData(t.data),
        p.reloadData(e)))
    }
    ,
    function(t) {
        ...
        t.update = function() {
            var e = arguments
              , e = (O.extend(n.getNodeDataByIndex(l), e[0]),
            r.apply(this, e));
            return n.renderTreeTable(t.tr, t.tr.attr("data-level"), !1),
            e
        }
        ,
        t.del = function() {
      ...
      , u = (p.updateNode = function(e, a, t) {
        var n, i, l, r, d = E(e);
        d && ((l = d.getOptions()).tree,
        l = (n = l.elem.next()).find('tr[lay-data-index="' + a + '"]'),
        i = l.attr("data-index"),
        l = l.attr("data-level"),
        t && (t = d.getNodeDataByIndex(a, !1, t),
        r = Y.getTrHtml(e, [t]),
    ...
    p.removeNode = function(e, t) {
        var a, n, i, l, r = E(e);
        r && (l = (i = r.getOptions()).tree,
        a = i.elem.next(),
        n = [],
        i = r.getNodeDataByIndex("string" === layui.type(t) ? t : t[B], !1, "delete"),
    ...
    p.addNodes = function(e, t) {
        ...
        if (y)
            ...
            y.getTableData(),
            n ? (r = f.customName.isParent,
            f = f.customName.children,
            n[r] = !0,
            c = (c = n[f]) ? (d = c.splice(-1 === i ? c.length : i),
            n[f] = c.concat(l, d)) : n[f] = l,
            ...
            }, !0)) : (d = Y.cache[e].splice(-1 === i ? Y.cache[e].length : i),
            Y.cache[e] = Y.cache[e].concat(l, d),
            u.url || (u.page ? (c = u.page,
            u.data.splice.apply(u.data, [c.limit * (c.curr - 1), c.limit].concat(Y.cache[e]))) : u.data = Y.cache[e]),
            y.initData(),
            f = Y.getTrHtml(e, l),
            o = {
                trs: O(f.trs.join("")),
            ...
            f.find("tbody").append(o.trs_fixed_r)) : (s = d[0][h],
            ...
            p.resize(e),
            t && a.find(L).find('tr[lay-data-index="' + l[0][B] + '"]').get(0).scrollIntoViewIfNeeded(),
            l
    }
    ,
    ...
    p.on("edit", function(e) {
        ...
        t.id;
        a.hasClass("layui-table-tree") && (n(e),
        e.field === t.tree.customName.name && (e.tr.find('td[data-field="' + e.field + '"]').children("div.layui-table-cell").removeClass("layui-table-tree-item"),
        e.update({})))
    }),
    ...
    t.prototype.updateCheckStatus = function(e, t) {
        ...
        a.id)
          ...
          , r = (e && (a = this.updateParentCheckStatus(e, t),
        layui.each(a, function(e, t) {
    ...
    t.prototype.updateParentCheckStatus = function(a, n) {
        ...
        a[i] = n,
        l.push(O.extend({}, a)),
        l = a[f] ? l.concat(this.updateParentCheckStatus(Y.cache[e][a[f]], n)) : l
    }
    ,
    function(e, t, a) {
        var n = this
        ...
        if (a) {
            ...
            a && (n.updateStatus(null, function(e) {
                e[u] && (e[u] = !1,
                y.render(r.find('tr[lay-data-index="' + e[B] + '"] input[type="radio"][lay-type="layTableRadio"]').prop("checked", !1)))
            }),
            a[u] = t,
...
layui.define(["lay", "util", "element", "form"], function(e) {
    ...
    e("code", function(e) {
        ...
        e.elem[0] && layui.each(e.elem.get().reverse(), function(e, a) {
            var i, l, t, s, o, n, d, c, r, u, E = M(a), y = M.extend(!0, {}, L, lay.options(a), (i = {},
            ...
            c = {
                full: {
                    ...
                    event: function(e, a) {
                        ...
                        e.hasClass(i) ? (l.addClass(b.ELEM_FULL),
                        e.removeClass(i).addClass(t),
                        e.attr("title", s[1]),
                        o.addClass(n)) : (l.removeClass(b.ELEM_FULL),
            ...
            r = function(e) {
                var a = e.children("iframe")[0]
                  , l = (s && a ? a.srcdoc = v.join("") : e.html(v.join("")),
                {
                    container: e,
                    render: function() {
                        C.render(e.find(".layui-form")),
                        w.render()
                    }
                });
                setTimeout(function() {
            ...
            ,
            "preview" === t[0] ? (n.addClass(b.ELEM_SHOW),
            E.before(n),
            r(n)) : E.addClass(b.ELEM_SHOW).after(n),
            ...
            w.on("tab(" + a + ")", function(e) {
                var a = M(this)
                  , l = M(e.elem).closest("." + b.ELEM_PREVIEW).find("." + b.ELEM_ITEM)
                  , e = l.eq(e.index);
                l.removeClass(b.ELEM_SHOW),
                e.addClass(b.ELEM_SHOW),
                "preview" === a.attr("lay-id") && r(e)
            })),
            y.ln ? "ol" : "ul"), p = M("<" + f + ' class="layui-code-' + f + '">'), m = M('<div class="' + b.ELEM_TITLE + '">'), h = (E.addClass("layui-code-view layui-box"),
            y.skin && ("notepad" === y.skin && (y.skin = "dark"),
            E.removeClass("layui-code-dark layui-code-light"),
            E.addClass("layui-code-" + y.skin)),
            _.escape(v.join(""))), h = (h = y.encode ? _.escape(h) : h).replace(/[\r\t\n]+/g, "</li><li>");
            E.html(p.html("<li>" + h + "</li>")),
            y.header && !E.children("." + b.ELEM_TITLE)[0] && (m.html(y.title + (y.about ? '<div class="layui-code-about">' + y.about + "</div>" : "")),
            E.prepend(m)),
            y.elem.length === e + 1 && "function" == typeof y.allDone && y.allDone(),
            0 < (u = Math.floor(p.find("li").length / 100)) && p.css("margin-left", u + "px"),
